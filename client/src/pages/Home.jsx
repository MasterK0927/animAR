      ...
      {snap.intro && (
        <motion.section className="home" {...slideAnimation("left")}>
          <motion.header {...slideAnimation("down")} className="flex justify-center items-center">
            ...
            />
            <a href='http://127.0.0.1:5000' target="_blank"><button class="center w-15 h-10 bg-blue-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full transition duration-500 transform hover:scale-105 focus:outline-none focus:shadow-outline-blue active:bg-blue-800 animate-colorChange">AR</button></a>
          </motion.header>
